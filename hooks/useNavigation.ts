...
export function useNavigation() {
    ...
    const { setCurrentContext, addRecentProject, addRecentQuest, addRecentAsset } = useLocalStore();
    ...
    const goToProject = useCallback((projectData: { id: string; name?: string }, navigate = false) => {
    ...
    const goToQuest = useCallback((questData: { id: string; project_id: string; name?: string }, navigate = false) => {
