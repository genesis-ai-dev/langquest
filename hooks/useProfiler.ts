...
export function useProfiler({
    ...
    const trackEffectExecution = useCallback((effectId: string, dependencies?: unknown[]) => {
    ...
    const trackState = useCallback((stateName: string, oldValue?: unknown, newValue?: unknown) => {
