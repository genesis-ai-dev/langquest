...
function DrawerHandle({
  ...
  return (
    <DrawerPrimitive.Handle
      ...
      {...props}
      className={cn(
        'mx-auto mb-4 hidden h-2 w-[100px] shrink-0 rounded-full group-data-[vaul-drawer-direction=bottom]/drawer-content:block',
        className
      )}
    />
  );
  ...
  return (
    <DrawerPortal data-slot="drawer-portal">
      ...
      <DrawerPrimitive.Content
        ...
        className={cn(
          'group/drawer-content fixed z-[9999] flex h-auto flex-col border-border bg-background',
...
export type BottomSheetModal = unknown;
