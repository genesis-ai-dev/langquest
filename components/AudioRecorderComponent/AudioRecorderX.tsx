...
const AudioRecorder: React.FC<AudioRecorderProps> = ({
  ...
  // This is causing a race condition between AudioManager's stopRecording method (this.currentAudioUri) and this hook's checking of getCurrentAudioUri
  // A useEffect in this scenario is not a good idea
  // useEffect(() => {
  //   console.log('Monitor recording state:', snapshot.value);
  //   if (snapshot.value === 'recordingStopped') {
  //     const uri = audioManager.getCurrentAudioUri();
  //     if (uri) {
  ...
  //     }
  //   }
  // }, [snapshot.value, audioManager, onRecordingComplete]);
