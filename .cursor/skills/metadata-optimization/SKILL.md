...
**Writing style:** Before drafting or revising copy, read `.cursor/rules/writing.mdc` (especially **App Store and Play Store copy**). Metadata must follow those voice, banned-word, and clarity rules—not generic marketing language.
...
- `.cursor/rules/writing.mdc` — Voice, banned words, and store-listing style (required for all user-facing copy)
