/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 4a636c4c2536fd9148be1a0336963a7c)
// Runtime types generated with workerd@1.20260518.1 2026-05-19 nodejs_compat
interface __BaseEnv_Env {
	SUPABASE_WEBHOOK_TARGETS: '["https://yjgdgsycxmlvaiuynlbv.supabase.co/functions/v1/resend-webhook","https://unsxkmlcyxgtgmtzfonb.supabase.co/functions/v1/resend-webhook"]';
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, 'SUPABASE_WEBHOOK_TARGETS'>> {}
}
