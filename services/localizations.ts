...
export const localizations = {
  ...
  loadingAssets: {
    english: 'Loading assets...',
    french: 'Chargement des actifs...',
    spanish: 'Cargando recursos...',
    brazilian_portuguese: 'Carregando recursos...',
    tok_pisin: 'Loadim ol Asset...',
    indonesian: 'Memuat aset...',
    nepali: 'एसेटहरू लोड हुँदैछन्...',
    hindi: 'एसेट लोड हो रहे हैं...',
    burmese: 'ပိုင်ဆိုင်မှုများကို ဖွင့်နေသည်...',
    thai: 'กำลังโหลดสินทรัพย์...',
    mandarin: '正在加载资产...'
  },
  ...
  versions: {
    ...
    french: 'versions',
    spanish: 'versiones',
    brazilian_portuguese: 'versões',
    tok_pisin: 'versions',
    indonesian: 'versi',
    nepali: 'संस्करणहरू',
    hindi: 'संस्करण',
    burmese: 'ဗားရှင်းများ',
    thai: 'เวอร์ชัน',
    mandarin: '版本'
  },
  pericope: {
    ...
    french: 'Passage',
    spanish: 'Pasaje',
    brazilian_portuguese: 'Passagem',
    tok_pisin: 'Hap bilong Baibel',
    indonesian: 'Perikop',
    nepali: 'खण्ड',
    hindi: 'अंश',
    burmese: 'ကျမ်းပိုင်း',
  ...
  pericopes: {
    ...
    french: 'Passages',
    spanish: 'Pasajes',
    brazilian_portuguese: 'Passagens',
    tok_pisin: 'Ol hap bilong Baibel',
    indonesian: 'Perikop',
    nepali: 'खण्डहरू',
    hindi: 'अंश',
    burmese: 'ကျမ်းပိုင်းများ',
    thai: 'ตอน',
    mandarin: '经文'
  },
  createNewVersion: {
    english: 'Create New Version',
    french: 'Créer une nouvelle version',
    spanish: 'Crear una nueva versión',
    brazilian_portuguese: 'Criar uma nova versão',
    tok_pisin: 'Pikin wanpela version',
    indonesian: 'Buat versi baru',
    nepali: 'नयाँ संस्करण बनाउनुहोस्',
    hindi: 'नया संस्करण बनाएं',
    burmese: 'မှတ်ချက်များအသစ်ထည့်ပါ',
    thai: 'สร้างรุ่นใหม่',
    mandarin: '创建新版本'
  },
  startNewRecording: {
    english: 'Start a fresh recording',
    french: 'Commencer un nouvel enregistrement',
    spanish: 'Iniciar una nueva grabación',
    brazilian_portuguese: 'Iniciar uma nova gravação',
    tok_pisin: 'Statim nupela rekoding',
    indonesian: 'Mulai rekaman baru',
    nepali: 'नयाँ रेकर्डिङ सुरु गर्नुहोस्',
    hindi: 'नई रिकॉर्डिंग शुरू करें',
    burmese: 'အသံသွင်းမှုအသစ် စတင်ပါ',
    thai: 'เริ่มการบันทึกใหม่',
    mandarin: '开始新的录音'
  },
  available: {
    english: 'available',
    french: 'disponible',
    spanish: 'disponible',
    brazilian_portuguese: 'disponível',
    tok_pisin: 'disponible',
    indonesian: 'tersedia'
  },
  available_plural: {
    english: 'available',
    french: 'disponibles',
    spanish: 'disponibles',
    brazilian_portuguese: 'disponíveis',
    tok_pisin: 'disponible',
    indonesian: 'tersedia',
    nepali: 'उपलब्ध',
    hindi: 'उपलब्ध',
    burmese: 'အသုံးပြုနိုင်သည်',
    thai: 'มีอยู่',
    mandarin: '可用'
  },
  noMediaAvailable: {
    english: 'No media available for this passage.',
    french: 'Aucun média disponible pour ce passage.',
    spanish: 'No hay medios disponibles para este pasaje.',
    brazilian_portuguese: 'Nenhuma mídia disponível para esta passagem.',
    tok_pisin: 'I no gat media bilong dispela hap bilong Baibel.',
    indonesian: 'Tidak ada media yang tersedia untuk perikop ini.',
    nepali: 'यो खण्डका लागि कुनै मीडिया उपलब्ध छैन।',
    hindi: 'इस अंश के लिए कोई मीडिया उपलब्ध नहीं है।',
    burmese: 'ဤကျမ်းပိုင်းအတွက် မီဒီယာ မရရှိနိုင်ပါ။',
    thai: 'ไม่มีสื่อสำหรับตอนพระคัมภีร์นี้',
    mandarin: '此经文没有可用的媒体。'
  },
  noFIAContentAvailable: {
    english: 'No FIA content available for this language.',
    french: 'Aucun contenu FIA disponible pour cette langue.',
    spanish: 'No hay contenido FIA disponible para esta lengua.',
    brazilian_portuguese: 'Nenhum conteúdo FIA disponível para esta língua.',
    tok_pisin: 'I no gat FIA content bilong langu na pericope.',
    indonesian: 'Tidak ada konten FIA yang tersedia untuk bahasa ini.',
    nepali: 'यो भाषाका लागि कुनै FIA सामग्री उपलब्ध छैन।',
    hindi: 'इस भाषा के लिए कोई FIA सामग्री उपलब्ध नहीं है।',
    burmese: 'ဤဘာသာစကားအတွက် FIA အကြောင်းအရာ မရှိပါ။',
    thai: 'ไม่มีสิ่งพิมพ์ FIA สำหรับภาษานี้',
    mandarin: '此语言没有可用的 FIA 内容。'
  },
  noTextAvailable: {
    english: 'No text available for this step.',
    french: 'Aucun texte disponible pour cette étape.',
    spanish: 'No hay texto disponible para este paso.',
    brazilian_portuguese: 'Nenhum texto disponível para esta etapa.',
    tok_pisin: 'I no gat teks bilong dispela step.',
    indonesian: 'Tidak ada teks yang tersedia untuk langkah ini.',
    nepali: 'यो चरणका लागि कुनै पाठ उपलब्ध छैन।',
    hindi: 'इस चरण के लिए कोई पाठ उपलब्ध नहीं है।',
    burmese: 'ဤအဆင့်အတွက် စာသား မရှိပါ။',
    thai: 'ไม่มีข้อความสำหรับขั้นตอนนี้',
    mandarin: '此步骤没有可用的文本。'
  },
  loadingCompatibleQuests: {
    english: 'Loading compatible quests...',
    french: 'Chargement des quêtes compatibles...',
    spanish: 'Cargando misiones compatibles...',
    brazilian_portuguese: 'Carregando missões compatíveis...',
    tok_pisin: 'Lodim ol Quest i stret wantaim...',
    indonesian: 'Memuat misi yang kompatibel...',
    nepali: 'मिल्दो क्वेस्टहरू लोड हुँदैछन्...',
    hindi: 'संगत क्वेस्ट लोड हो रहे हैं...',
    burmese: 'ကိုက်ညီသော Quest များကို ဖွင့်နေသည်...',
    thai: 'กำลังโหลดเควสต์ที่เข้ากันได้...',
    mandarin: '正在加载兼容的任务...'
  },
  noPublishedVersionsFound: {
    english: 'No published versions found',
    french: 'Aucune version publiée trouvée',
    spanish: 'No se encontraron versiones publicadas',
    brazilian_portuguese: 'Nenhuma versão publicada encontrada',
    tok_pisin: 'I no gat ol vesin i bin publish',
    indonesian: 'Tidak ada versi yang dipublikasikan',
    nepali: 'कुनै प्रकाशित संस्करण फेला परेन',
    hindi: 'कोई प्रकाशित संस्करण नहीं मिला',
    burmese: 'ထုတ်ဝေထားသော ဗားရှင်းများ မတွေ့ပါ',
    thai: 'ไม่พบเวอร์ชันที่เผยแพร่',
    mandarin: '未找到已发布的版本'
  },
  noOtherQuestsPublished: {
    english: 'No other published quests for this reference.',
    french: 'Aucune autre quête publiée pour cette référence.',
    spanish: 'No hay otras misiones publicadas para esta referencia.',
    brazilian_portuguese:
      'Não há outras missões publicadas para esta referência.',
    tok_pisin: 'I no gat narapela Quest i bin publish bilong dispela referens.',
    indonesian: 'Tidak ada misi lain yang dipublikasikan untuk referensi ini.',
    nepali: 'यस सन्दर्भका लागि अन्य कुनै प्रकाशित क्वेस्टहरू छैनन्।',
    hindi: 'इस संदर्भ के लिए कोई अन्य प्रकाशित क्वेस्ट नहीं है।',
    burmese: 'ဤရည်ညွှန်းချက်အတွက် အခြားထုတ်ဝေထားသော Quest များ မရှိပါ။',
    thai: 'ไม่มีเควสต์อื่นที่เผยแพร่สำหรับข้อมูลอ้างอิงนี้',
    mandarin: '此参考没有其他已发布的任务。'
  },
  resolveConflictsBeforeProceeding: {
    english: 'Resolve conflicts before proceeding.',
    french: 'Résolvez les conflits avant de continuer.',
    spanish: 'Resuelva los conflictos antes de continuar.',
    brazilian_portuguese: 'Resolva os conflitos antes de continuar.',
    tok_pisin: 'Stretim ol hevi pastaim, na bihain go het.',
    indonesian: 'Selesaikan konflik sebelum melanjutkan.',
    nepali: 'अगाडि बढ्नुअघि द्वन्द्वहरू समाधान गर्नुहोस्।',
    hindi: 'आगे बढ़ने से पहले टकरावों को हल करें।',
    burmese: 'ဆက်လက်မလုပ်ဆောင်မီ ပဋိပက္ခများကို ဖြေရှင်းပါ။',
    thai: 'แก้ไขข้อขัดแย้งก่อนดำเนินการต่อ',
    mandarin: '继续之前请解决冲突。'
  },
  assignVerseLabel: {
    english: 'Assign verse label',
    french: 'Attribuer une étiquette de verset',
    spanish: 'Asignar etiqueta de versículo',
    brazilian_portuguese: 'Atribuir rótulo de versículo',
    tok_pisin: 'Putim ves label',
    indonesian: 'Tetapkan label ayat',
    nepali: 'पदको लेबल तोक्नुहोस्',
    hindi: 'पद का लेबल निर्धारित करें',
    burmese: 'ကျမ်းပိုဒ် အညွှန်း သတ်မှတ်ပါ',
    thai: 'กำหนดป้ายกำกับข้อพระคัมภีร์',
    mandarin: '分配经文标签'
  },
  assignVerseLabelDescription: {
    english:
      'This assignment will only be applied when the assets are imported.',
    french:
      'Cette attribution ne sera appliquée que lors de l’importation des éléments.',
    spanish: 'Esta asignación solo se aplicará al importar los elementos.',
    brazilian_portuguese:
      'Esta atribuição só será aplicada quando os elementos forem importados.',
    tok_pisin: 'Dispela assignment bai kamap tasol taim ol items i kam insait.',
    indonesian: 'Penetapan ini hanya akan diterapkan saat elemen diimpor.',
    nepali: 'यो असाइनमेन्ट एसेटहरू आयात गर्दा मात्र लागू हुनेछ।',
    hindi: 'यह असाइनमेंट एसेट आयात किए जाने पर ही लागू होगा।',
