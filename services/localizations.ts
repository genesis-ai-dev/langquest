...
french: 'Veuillez vérifier votre adresse e-mail avant de vous connecter. Vérifiez votre e-mail pour le lien de vérification.',
    spanish:
...
french: 'Veuillez vérifier votre courrier électronique pour le lien de réinitialisation du mot de passe',
    spanish:
...
french: 'Si vous ne téléchargez pas le projet, vous ne pourrez pas y contribuer hors ligne. Vous pourrez le télécharger plus tard en appuyant sur le bouton de téléchargement de la fiche du projet.',
    spanish:
...
french: 'Supprimez les données locales pour libérer de l\'espace de stockage',
...
french: 'Veuillez attendre que toutes les modifications soient téléchargées sur le cloud avant de les décharger. Connectez-vous à Internet et attendez la fin de la synchronisation.',
    spanish:
...
french: 'Cela supprimera les copies locales. Les données resteront en sécurité dans le cloud et pourront être retéléchargées ultérieurement.',
    spanish:
...
french: 'Certaines erreurs se sont produites lors de la découverte. Vous pouvez toujours télécharger les enregistrements découverts.',
    spanish:
...
french: 'Quête introuvable dans la base de données cloud. Il se peut qu\'il n\'existe que localement ou que vous n\'ayez pas la permission d\'y accéder. Essayez d\'actualiser la page ou contactez l\'assistance si cela persiste.',
    spanish:
...
french: 'Invitation acceptée, mais le téléchargement du projet a échoué. Vous pourrez le télécharger plus tard depuis la page des projets.',
    spanish:
...
french: 'Aucune langue trouvée dans cette région. Vous pouvez créer une nouvelle langue ci-dessous.',
    spanish:
...
french: 'Quelque chose s\'est mal passé… Veuillez vérifier votre e-mail et votre mot de passe.',
...
french: 'Êtes-vous sûr de vouloir supprimer {count} élément(s) ? Cette action ne peut pas être annulée.',
    spanish:
...
french: 'Êtes-vous sûr de vouloir fusionner {count} éléments ? Les segments audio seront combinés dans le premier élément sélectionné et les autres seront supprimés.',
    spanish:
...
french: 'Aucun actif pour l\'instant. Commencez l\'enregistrement pour créer votre premier élément.',
    spanish:
...
french: 'Vous verrez les invitations à des projets et les demandes de participation ici',
...
french: 'J\'ai lu et j\'accepte le {link}',
...
french: 'En appuyant sur {iAgree}, vous acceptez que tout le contenu que vous contribuez à LangQuest sera disponible gratuitement dans le monde entier sous la dédicace au domaine public CC0 1.0 Universal (CC0 1.0).',
    spanish:
...
french: 'Cela signifie que vos contributions peuvent être utilisées par n’importe qui à n’importe quelle fin sans attribution. Nous collectons un minimum de données utilisateur : uniquement votre e-mail (pour la récupération de compte) et votre abonnement à la newsletter si vous y êtes inscrit.',
    spanish:
...
french: 'Nous collectons des données d\'analyse et de diagnostic pour améliorer l\'application et votre expérience. Vous pouvez vous désinscrire des analyses à tout moment dans les paramètres de votre profil. Vos données sont traitées et stockées aux États-Unis.',
    spanish:
...
french: 'Lorsqu\'elle est désactivée, nous ne collecterons pas de données d\'utilisation pour améliorer l\'application.',
    spanish:
...
french: 'Vous essayez de télécharger {newDownloads} pièces jointes pour un total de {totalDownloads}, mais la limite est de {limit}. Veuillez désélectionner certains téléchargements et réessayer.',
    spanish:
...
french: 'Vous êtes actuellement hors ligne. Si vous supprimez ce téléchargement, vous ne pourrez pas le télécharger à nouveau tant que vous ne serez pas de nouveau en ligne. Vos contributions non synchronisées ne seront pas affectées.',
    spanish:
...
french: 'Souhaitez-vous sauvegarder vos enregistrements audio non synchronisés ?',
    spanish:
...
french: 'Autorisation de stockage refusée. La sauvegarde ne peut pas continuer.',
    spanish:
...
french: 'Les propriétaires peuvent créer du contenu, inviter et promouvoir d\'autres membres, et ne peuvent pas être rétrogradés au rang de membre ou supprimés d\'un projet par d\'autres membres.',
    spanish:
...
french: 'Êtes-vous sûr de vouloir faire de {name} propriétaire ? Cette action ne peut pas être annulée.',
    spanish:
...
french: 'Vous ne pouvez pas quitter ce projet car vous en êtes le seul propriétaire. Veuillez d\'abord promouvoir un autre membre au rang de propriétaire.',
    spanish:
...
french: 'Le projet est ouvert à tous, mais seuls les membres peuvent y contribuer.',
    spanish:
...
french: 'Pour contribuer à ce projet, vous devez demander votre adhésion. Les porteurs de projet examineront votre demande.',
    spanish:
...
french: 'Il s\'agit d\'un projet privé. Vous devez être connecté pour demander l\'accès.',
    spanish:
...
french: 'Veuillez vous connecter pour demander l\'adhésion à ce projet privé.',
    spanish:
...
french: 'Votre demande d\'adhésion est en attente d\'examen par les propriétaires du projet.',
    spanish:
...
french: 'Votre demande d\'adhésion a expiré. Vous pouvez soumettre une nouvelle demande.',
    spanish:
...
french: 'Votre demande d\'adhésion a été refusée. Vous disposez de {attempts} tentatives supplémentaires pour demander votre adhésion.',
    spanish:
...
french: 'Votre demande d\'adhésion a été refusée et vous avez atteint le nombre maximum de tentatives.',
    spanish:
...
french: 'Vous avez retiré votre demande d\'adhésion. Vous pouvez soumettre une nouvelle demande à tout moment.',
    spanish:
...
french: 'Ce projet est privé. Vous pouvez télécharger le contenu mais vous ne pourrez pas contribuer aux traductions ni aux votes. Demandez l’accès pour rejoindre ce projet et commencez à contribuer.',
    spanish:
...
french: 'Ce projet est privé. Vous devez être membre pour modifier les transcriptions. Demandez l\'accès pour rejoindre ce projet.',
    spanish:
...
french: 'Ce projet est privé. Vous devez être membre pour accéder à cette fonctionnalité. Demandez l\'accès pour rejoindre ce projet.',
    spanish:
...
french: 'Vous devez être membre pour consulter la liste des membres et envoyer des invitations. Demandez l\'accès pour rejoindre ce projet.',
    spanish:
...
french: 'Ce projet est privé. Vous devez être membre pour soumettre des traductions. Demandez l\'accès pour rejoindre ce projet.',
    spanish:
...
french: 'Ce projet est privé. Vous devez être membre pour voter sur les traductions. Demandez l\'accès pour rejoindre ce projet.',
    spanish:
...
french: '{sender} vous a invité à rejoindre le projet "{project}" en tant que {role}',
    spanish:
...
french: '{sender} a demandé à rejoindre le projet "{project}" en tant que {role}',
    spanish:
...
french: 'Votre demande a expiré après 7 jours. Il vous reste {attempts} tentatives{plural}.',
    spanish:
...
french: 'Votre demande précédente a expiré après 7 jours. Il vous reste {attempts} tentatives{plural}.',
    spanish:
...
french: 'Votre demande précédente a expiré au bout de 7 jours et il ne vous reste plus aucune tentative.',
    spanish:
...
french: 'Votre demande d\'adhésion est en attente d\'approbation. Vous serez averti lorsqu\'il sera examiné.',
    spanish:
...
french: 'Votre demande a été refusée. Il vous reste {attempts} tentatives{plural}.',
    spanish:
...
french: 'Votre demande a été refusée et il ne vous reste plus aucune tentative.',
...
french: 'Vous avez retiré votre demande précédente. Vous pouvez envoyer une nouvelle demande à tout moment.',
    spanish:
...
french: 'Laissez-nous ajuster automatiquement la sensibilité à votre environnement',
    spanish:
...
french: 'Cela restaurera vos fichiers audio à partir de la sauvegarde. Continuer?',
    spanish:
...
french: 'Restauration terminée : {audioCopied} fichiers audio copiés, {audioSkippedDueToError} ignorés en raison d\'erreurs',
    spanish:
...
french: '{sender} vous a invité à rejoindre « {project} » en tant que {role}',
...
french: 'Vous êtes hors ligne. Toutes les modifications que vous apportez seront synchronisées lorsque vous serez de nouveau en ligne.',
    spanish:
...
french: 'L\'actif est visible par défaut dans toutes les quêtes, à moins qu\'il ne soit masqué individuellement.',
    spanish:
...
french: 'L\'actif est actif et peut être utilisé dans toutes les quêtes, à moins qu\'il ne soit désactivé individuellement.',
    spanish:
...
french: 'L\'actif est visible par défaut dans cette quête, à moins qu\'il ne soit masqué individuellement.',
    spanish:
...
french: 'L\'actif est caché dans toutes les quêtes et ne peut être rendu visible dans aucune d\'entre elles.',
    spanish:
...
french: 'L\'atout est désactivé dans toutes les quêtes et ne peut être utilisé nulle part.',
    spanish:
...
french: 'Ces paramètres affectent le comportement de l\'actif dans toutes les quêtes.',
    spanish:
...
french: 'Ces paramètres affectent le comportement de l\'actif dans cette quête spécifique.',
    spanish:
...
french: 'Cet actif est désactivé globalement. Vous ne pouvez pas modifier ses paramètres pour cette quête.',
    spanish:
...
french: 'L\'atout peut être utilisé dans cette quête. Sauf désactivation globale.',
    spanish:
...
french: 'Démarrer la session d\'enregistrement',
...
french: 'Ce projet apparaît dans les listes publiques et peut être découvert par tous les utilisateurs.',
    spanish:
...
french: 'Ce projet n\'est pas affiché dans les répertoires de projets ni dans les résultats de recherche.',
    spanish:
...
french: 'Le projet est actuellement ouvert à la visualisation et aux contributions.',
    spanish:
...
french: 'Ce projet est actuellement inactif et n\'accepte pas de contributions.',
    spanish:
...
french: 'Échec de l\'initialisation de l\'application. Veuillez essayer de vous déconnecter et de vous reconnecter.',
    spanish:
...
french: 'Êtes-vous sûr de vouloir effacer toutes les données mises en cache ?',
...
french: 'Recevez des notifications pour les mises à jour de l\'application et les informations importantes',
    spanish:
...
french: 'Téléchargez du contenu uniquement lorsque vous êtes connecté au WiFi',
...
french: 'Effacez toutes les données mises en cache pour libérer de l\'espace de stockage',
    spanish:
...
french: 'Activez les suggestions de traduction basées sur l\'IA basées sur les traductions à proximité',
    spanish:
...
french: 'Activer la fonctionnalité de lecture de tous les éléments pour lire tous les éléments audio dans l\'ordre',
    spanish:
...
french: 'Activer le mode débogage pour les fonctionnalités de développement',
...
french: 'Cette traduction est actuellement active. Une traduction active est également visible.',
    spanish:
...
french: 'Cette traduction est inactive. Aucune action ne peut être effectuée à moins d\'être réactivée.',
    spanish:
...
french: 'Cette traduction est masquée et ne sera pas montrée aux autres utilisateurs. Une traduction invisible est également inactive.',
    spanish:
...
french: 'Cet actif est local uniquement. Le texte peut être modifié jusqu\'à sa publication.',
    spanish:
...
french: 'Quelle quantité de silence est nécessaire pour déterminer les limites des segments.',
    spanish:
...
french: 'Supprimer les segments en dessous de cette durée (filtrer les bruits brefs)',
    spanish:
...
french: 'Choisissez comment la forme d\'onde apparaît lors de l\'enregistrement',
...
french: 'Lorsqu\'un son est détecté, un segment démarre automatiquement l\'enregistrement. Après un moment de silence, le segment sera enregistré. Vous pouvez enregistrer plusieurs segments comme celui-ci en séquence pendant que l\'enregistrement est activé.',
    spanish:
...
french: 'La sensibilité définit le seuil pour déterminer quand un clip commence et se termine. Une sensibilité plus faible capte les paroles plus calmes, mais également d\'autres bruits potentiels.',
    spanish:
...
french: 'Une durée de pause plus courte divisera votre enregistrement en plusieurs segments avec des pauses plus petites.',
    spanish:
...
french: 'La longueur minimale de segment empêche l\'enregistrement de segments très courts en dessous de la durée définie, comme la toux ou les claquements de porte.',
    spanish:
...
french: 'le bouton d\'enregistrement pour démarrer l\'enregistrement de détection d\'activité vocale (VAD). Cela créera automatiquement de nouveaux segments audio chaque fois que vous faites une pause pendant que vous parlez. Appuyez à nouveau pour mettre fin à la session VAD.',
    spanish:
...
french: 'pour enregistrer un seul segment, relâchez pour arrêter l\'enregistrement.',
...
french: 'L\'étalonnage a échoué. Veuillez réessayer dans un environnement plus calme.',
    spanish:
...
french: 'Pendant l\'auto-calibrage, restez silencieux ou autorisez uniquement les sons que vous souhaitez être inférieurs au seuil de sensibilité.',
    spanish:
...
french: 'Une nouvelle version de l\'application est requise pour accéder aux dernières fonctionnalités. Veuillez mettre à jour pour continuer.',
    spanish:
...
french: 'La version de votre application est plus récente que celle du serveur. Veuillez contacter le support ou attendre que le serveur soit mis à jour.',
    spanish:
...
french: 'Votre base de données de pièces jointes est saine. Tous les enregistrements de pièces jointes sont valides.',
    spanish:
...
french: '{count} pièce jointe corrompue contenant des URL de blob a été trouvée dans la base de données. Ceux-ci provoquent des erreurs de synchronisation et doivent être nettoyés.',
    spanish:
...
french: '{count} pièces jointes corrompues contenant des URL de blob ont été trouvées dans la base de données. Ceux-ci provoquent des erreurs de synchronisation et doivent être nettoyés.',
    spanish:
...
french: 'Cela supprimera l\'enregistrement de pièce jointe corrompu et ses références de la base de données. Cette action ne peut pas être annulée.',
    spanish:
...
french: 'Cela nettoiera la pièce jointe corrompue {count}. Cette action ne peut pas être annulée.',
    spanish:
...
french: 'Cela nettoiera {count} pièces jointes corrompues. Cette action ne peut pas être annulée.',
    spanish:
...
french: 'Pièce jointe {cleaned} nettoyée. Une erreur {errorCount} s\'est produite :\n\n{errors}',
    spanish:
...
french: 'Pièces jointes {cleaned} nettoyées. {errorCount} erreurs se sont produites :\n\n{errors}',
    spanish:
...
french: '{cleaned} pièces jointes corrompues ont été nettoyées avec succès.',
...
french: 'Échec du chargement des pièces jointes corrompues. Veuillez réessayer.',
    spanish:
...
french: 'Après avoir supprimé votre compte, vous ne pourrez plus vous inscrire ni vous connecter hors ligne. Vous devez être en ligne pour créer un nouveau compte ou vous connecter.',
    spanish:
...
french: 'Votre compte sera désactivé (suppression logicielle). Toutes vos données seront conservées, mais vous ne pourrez pas accéder à l\'application tant que vous n\'aurez pas restauré votre compte. Vous pouvez restaurer votre compte à tout moment, mais vous devez être en ligne pour le faire.',
    spanish:
...
french: 'Toutes vos contributions (projets, quêtes, ressources, traductions, votes) seront conservées et resteront publiques selon les conditions que vous avez déjà acceptées lors de votre adhésion. Votre compte pourra être restauré à tout moment et toutes vos données seront à nouveau accessibles.',
    spanish:
...
french: 'Êtes-vous absolument sûr de vouloir supprimer votre compte ? Vous pourrez le restaurer plus tard, mais vous devrez être en ligne pour le faire.',
    spanish:
...
french: 'Votre compte sera supprimé (soft delete). Vous pouvez le restaurer plus tard à partir de l\'écran de connexion, mais vous devez être en ligne pour le restaurer.',
    spanish:
...
french: 'Votre compte a été supprimé avec succès (suppression logicielle). Vous pourrez le restaurer plus tard, mais vous devez être en ligne pour le faire. Vous serez déconnecté maintenant.',
    spanish:
...
french: 'Votre compte a été supprimé. Vous pouvez le restaurer pour retrouver l\'accès à toutes vos données, ou vous pouvez vous déconnecter et revenir à l\'écran de connexion.',
    spanish:
...
french: 'Votre compte sera entièrement restauré. Toutes vos données seront à nouveau accessibles et vous pourrez continuer à utiliser l\'application normalement.',
    spanish:
...
french: 'Nous stockons des informations sur ce qu\'il faut bloquer sur votre compte. Veuillez vous inscrire pour vous assurer que le contenu bloqué peut être correctement masqué.',
    spanish:
...
french: 'Veuillez vous connecter pour afficher l\'état du téléchargement et les informations de synchronisation.',
    spanish:
...
french: 'Maintenez le bouton enfoncé pour enregistrer ou faites glisser pour enregistrer à chaque fois que vous parlez',
    spanish:
...
french: 'Invitez les autres à collaborer. Ils recevront une notification et verront votre projet dans leur liste',
    spanish:
...
french: 'Chaque chapitre devient une quête sur laquelle vous pouvez travailler',
    spanish:
...
french: 'Collectez rapidement des données textuelles et audio. Local d\'abord, synchronisez une fois connecté. Collaborez, traduisez, validez.',
    spanish:
...
french: 'Les données CC0/domaine public garantissent qu’aucune partie ne peut arrêter cette vision.',
    spanish:
...
french: 'Sélectionnez la langue que vous souhaitez utiliser pour l\'interface de l\'application',
    spanish:
...
french: 'Cette exportation est destinée à la distribution et au partage publics.',
    spanish:
...
french: 'Exportez des chapitres de la Bible sous forme de fichiers audio pour le partage et la distribution',
    spanish:
...
french: 'Inclure du texte',
  ...
  singleZip: {
    english: 'Single Zip',
french: 'Fermeture éclair unique',
    spanish: 'ZIP único',
...
french: 'Aucune transcription pour l\'instant. Soyez le premier à transcrire !',
...
french: 'Remarque : Nous prévoyons de mettre en œuvre un lien vers le site Web LangQuest où les exportations pourront être consultées et commentées à l\'avenir.',
    spanish:
...
french: 'Cette fonctionnalité expérimentale permet d\'organiser les ressources bibliques à l\'aide d\'étiquettes de versets. Vous pouvez l\'activer/le désactiver à tout moment dans le menu Paramètres.',
    spanish:
...
french: 'Activer les étiquettes de versets pour aider à organiser les ressources bibliques',
    spanish:
...
french: 'Nous avons trouvé des langues existantes qui peuvent correspondre à celle que vous avez créée. Souhaitez-vous créer un lien vers une langue existante ?',
    spanish:
...
french: 'Obtenez des suggestions pour lier vos langues créées sur mesure à celles existantes dans la base de données',
    spanish:
...
french: 'Autoriser la fusion de plusieurs ressources audio en une seule ressource. À utiliser avec prudence : l\'ordre des segments peut nécessiter un ajustement manuel après la fusion.',
    spanish:
...
french: 'Activez les fonctionnalités du projet FIA. Il s\'agit d\'un type de projet expérimental en développement actif.',
    spanish:
...
french: 'Pour utiliser ce projet, activez les projets FIA dans Paramètres sous Fonctionnalités expérimentales.',
    spanish:
