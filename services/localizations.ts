...
export const localizations = {
  ...
  selectVerses: {
    english: 'Select Verses',
    spanish: 'Seleccionar Versículos',
    brazilian_portuguese: 'Selecionar Versículos',
    tok_pisin: 'Makim ol Ves',
    indonesian: 'Pilih Ayat'
  },
  noSelection: {
    english: 'No selection',
    spanish: 'Sin selección',
    brazilian_portuguese: 'Nenhuma seleção',
    tok_pisin: 'Nogat makim',
    indonesian: 'Tidak ada pilihan'
  },
  verse: {
    english: 'Verse',
    spanish: 'Versículo',
    brazilian_portuguese: 'Versículo',
    tok_pisin: 'Ves',
    indonesian: 'Ayat'
  },
  verses: {
    english: 'Verses',
    spanish: 'Versículos',
    brazilian_portuguese: 'Versículos',
    tok_pisin: 'Ol Ves',
    indonesian: 'Ayat-ayat'
  }
} as const;
