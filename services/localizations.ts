...
export const localizations = {
  ...
  statusTranslationActive: {
    ...
    burmese: 'ဤဘာသာပြန်ဆိုချက်သည် လက်ရှိတွင် အသက်ဝင်နေသည်။ အသက်ဝင်သော ဘာသာပြန်ဆိုချက်သည်လည်း မြင်နိုင်သည်။',
  ...
  statusTranslationInactive: {
    ...
    hindi: 'यह अनुवाद निष्क्रिय है। पुनः सक्रिय किए बिना कोई कार्रवाई नहीं की जा सकती।',
    burmese: 'ဤဘာသာပြန်ဆိုချက်သည် အသက်မဝင်ပါ။ ပြန်လည်အသက်သွင်းမသည်အထိ မည်သည့်လုပ်ဆောင်ချက်မျှ မပြုလုပ်နိုင်ပါ။',
  ...
  statusTranslationInvisible: {
    ...
    hindi: 'यह अनुवाद छिपा हुआ है और अन्य उपयोगकर्ताओं को नहीं दिखाया जाएगा। अदृश्य अनुवाद भी निष्क्रिय है।',
    burmese: 'ဤဘာသာပြန်ဆိုချက်ကို ဖျောက်ထားပြီး အခြားအသုံးပြုသူများကို မပြသပါ။ မမြင်ရသော ဘာသာပြန်ဆိုချက်သည်လည်း အသက်မဝင်ပါ။',
  ...
  localAssetEditHint: {
    ...
    hindi: 'यह एसेट केवल स्थानीय है। प्रकाशित होने तक पाठ संपादित किया जा सकता है।',
    burmese: 'ဤပိုင်ဆိုင်မှုသည် ဒေသခံသာဖြစ်သည်။ ထုတ်ဝေမချင်းစာသားကို တည်းဖြတ်နိုင်သည်။',
  ...
  vadMinSegmentLengthDescription: {
    ...
    burmese: 'ဤကြာချိန်ထက် နည်းသော အပိုင်းများကို ပယ်ပါ (တိုတောင်းသော အသံများကို စစ်ထုတ်ပါ)',
  ...
  vadHelpAutomatic: {
    ...
    mandarin: '检测到声音时，片段将自动开始录音。静音一段时间后，片段将被保存。录音激活时，您可以按顺序这样录制多个片段。'
  },
  vadHelpSensitivity: {
    english:
    ...
    mandarin: '灵敏度设置用于确定片段何时开始和结束的阈值。较低的灵敏度可捕捉较安静的语音，但也会捕捉其他潜在噪音。'
  },
  vadHelpPause: {
    english:
  ...
  recordingHelpVAD: {
    ...
    thai:
      'ปุ่มบันทึกเพื่อเริ่มการบันทึกด้วยการตรวจจับกิจกรรมเสียง (VAD) ซึ่งจะสร้างส่วนเสียงใหม่โดยอัตโนมัติเมื่อคุณหยุดพูดขณะพูด กดอีกครั้งเพื่อสิ้นสุดเซสชัน VAD',
    mandarin:
  ...
  recordingHelpPushToTalk: {
    ...
    burmese: 'အပိုင်းအစတစ်ခုကို မှတ်တမ်းတင်ရန်၊ မှတ်တမ်းတင်ခြင်းကို ရပ်တန့်ရန် လွှတ်ပါ။',
  ...
  vadCalibrationFailed: {
    ...
    hindi:
      'कैलिब्रेशन विफल। कृपया शांत वातावरण में पुनः प्रयास करें।',
    burmese:
  ...
  appUpgradeServerAhead: {
    ...
    thai:
      'ต้องใช้เวอร์ชันใหม่ของแอปเพื่อเข้าถึงฟีเจอร์ล่าสุด กรุณาอัปเดตเพื่อดำเนินการต่อ',
  ...
  appUpgradeServerBehind: {
    ...
    thai:
      'เวอร์ชันแอปของคุณใหม่กว่าซีร์เวอร์ กรุณาติดต่อฝ่ายสนับสนุนหรือรอให้ซีร์เวอร์อัปเดต',
  ...
  attachmentDatabaseHealthy: {
    ...
    burmese: 'သင်၏ ပူးတွဲဖိုင် ဒေတာဘေ့စ်သည် ကျန်းမာသည်။ ပူးတွဲဖိုင် မှတ်တမ်းအားလုံး တရားဝင်သည်။',
  ...
  cleanCorruptedAttachmentConfirm: {
    ...
    thai:
      'สิ่งนี้จะลบบันทึกไฟล์แนบที่เสียหายและการอ้างอิงจากฐานข้อมูล การกระทำนี้ไม่สามารถยกเลิกได้',
  ...
  cleanedAttachmentsWithErrors: {
    ...
    burmese: '{cleaned} ပူးတွဲဖိုင်ကို သန့်ရှင်းပြီး။ {errorCount} အမှား ဖြစ်ပွားခဲ့သည်:\n\n{errors}',
  ...
  cleanedAttachmentsWithErrorsPlural: {
    ...
    hindi: '{cleaned} संलग्नक साफ किए। {errorCount} त्रुटियां हुईं:\n\n{errors}',
    burmese: '{cleaned} ပူးတွဲဖိုင်များကို သန့်ရှင်းပြီး။ {errorCount} အမှားများ ဖြစ်ပွားခဲ့သည်:\n\n{errors}',
    thai: 'ล้างไฟล์แนบ {cleaned} รายการ เกิดข้อผิดพลาด {errorCount} รายการ:\n\n{errors}',
    mandarin: '已清理 {cleaned} 个附件。发生 {errorCount} 个错误:\n\n{errors}'
  },
  successfullyCleanedAttachments: {
    ...
    burmese: '{cleaned} ပျက်စီးသော ပူးတွဲဖိုင်ကို အောင်မြင်စွာ သန့်ရှင်းပြီးပါပြီ။',
  ...
  successfullyCleanedAttachmentsPlural: {
    ...
    burmese: '{cleaned} ပျက်စီးသော ပူးတွဲဖိုင်များကို အောင်မြင်စွာ သန့်ရှင်းပြီးပါပြီ။',
    thai: 'ล้างไฟล์แนบที่เสียหาย {cleaned} รายการสำเร็จ',
    mandarin: '已成功清理 {cleaned} 个损坏的附件。'
  },
  ...
  failedToLoadCorruptedAttachments: {
    ...
    burmese: 'ပျက်စီးသော ပူးတွဲဖိုင်များကို လုပ်ဆောင်ရန် မအောင်မြင်ပါ။ ကျေးဇူးပြု၍ ထပ်မံကြိုးစားပါ။',
  ...
  accountDeletionWarning: {
    ...
    mandarin: '删除账户后，您将无法在离线时注册或登录。您必须在线才能创建新账户或登录。'
  },
  accountDeletionPIIWarning: {
    ...
    mandarin: '您的账户将被停用（软删除）。您的所有数据将被保留，但在您恢复账户之前您将无法访问应用。您可以随时恢复账户，但必须在线。'
  },
  accountDeletionContributionsInfo: {
    ...
    mandarin: '您的所有贡献（项目、任务、资产、翻译、投票）将被保留，并将根据您加入时同意的条款保持公开。您可以随时恢复账户，所有数据将再次可访问。'
  },
  ...
  accountDeletionConfirmMessage: {
    ...
    mandarin: '您的账户将被删除（软删除）。您可以稍后从登录屏幕恢复，但必须在线才能恢复。'
  },
  ...
  accountDeletionSuccess: {
    ...
    mandarin: '您的账户已成功删除（软删除）。您可以稍后恢复，但必须在线。您现在将被登出。'
  },
  ...
  accountDeletedMessage: {
    ...
    mandarin: '您的账户已删除。您可以恢复它以重新访问所有数据，或登出并返回登录屏幕。'
  },
  restoreAccount: {
  ...
  restoreAccountConfirmMessage: {
    ...
    mandarin: '您的账户将被完全恢复。您的所有数据将再次可访问，您可以继续正常使用应用。'
  },
  accountRestoreSuccess: {
    ...
    burmese: 'သင်၏ အကောင့်ကို အောင်မြင်စွာ ပြန်လည်ရယူပြီးပါပြီ။ ပြန်လာသည့်အတွက် ကြိုဆိုပါသည်!',
  ...
  blockContentLoginMessage: {
    ...
    mandarin: '我们在您的账户中存储有关要屏蔽内容的信息。请注册以确保被屏蔽的内容可以正确隐藏。'
  },
  connected: {
    english: 'Connected',
    spanish: 'Conectado',
  ...
  signInToViewDownloadStatus: {
    ...
    burmese: 'ဒေါင်းလုဒ် အခြေအနေနှင့် ထပ်တူပြုခြင်း အချက်အလက်များကို ကြည့်ရှုရန် ကျေးဇူးပြု၍ ဝင်ရောက်ပါ။',
  ...
  onboardingRecordAudioSubtitle: {
    ...
    thai:
      'กดปุ่มค้างไว้เพื่อบันทึก หรือเลื่อนเพื่อบันทึกเมื่อใดก็ตามที่คุณพูด',
  ...
  onboardingInviteSubtitle: {
    ...
    thai:
      'เชิญผู้อื่นให้ร่วมมือกัน พวกเขาจะได้รับการแจ้งเตือนและเห็นโปรเจกต์ของคุณในรายการของพวกเขา',
  ...
  onboardingVisionSubtitle: {
    ...
    thai:
      'รวบรวมข้อมูลภาษาข้อความและเสียงอย่างรวดเร็ว เน้นท้องถิ่นก่อน ซิงค์เมื่อเชื่อมต่อ ร่วมมือ แปล และตรวจสอบ',
    mandarin: '快速收集文本和音频语言数据。本地优先，连接时同步。协作、翻译、验证。'
  },
  ...
  onboardingVisionCC0: {
    ...
    thai:
      'ข้อมูล CC0/สาธารณสมบัติรับประกันว่าไม่มีฝ่ายใดสามารถหยุดวิสัยทัศน์นี้ได้',
  ...
  exportForDistributionDescription: {
    ...
    burmese: 'ဤတင်ပို့မှုသည် ပြည်သူ့ ဖြန့်ဖြူးမှုနှင့် မျှဝေမှုအတွက် ရည်ရွယ်သည်။',
  ...
  noTranscriptionsYet: {
    ...
    hindi: 'अभी तक कोई ट्रांसक्रिप्शन नहीं है। पहले ट्रांसक्राइब करने वाले बनें!',
  ...
  feedbackLinkNote: {
    ...
    thai:
      'หมายเหตุ: เราวางแผนที่จะใช้ลิงก์ไปยังเว็บไซต์ LangQuest ซึ่งสามารถดูและแสดงความคิดเห็นเกี่ยวกับการส่งออกในอนาคต',
    mandarin: '注意：我们计划实施指向 LangQuest 网站的链接，将来可以在那里查看和评论导出内容。'
  },
  linkCopied: {
  ...
  enableVerseLabelsDescription: {
    ...
    thai:
      'ฟีเจอร์ทดลองนี้ช่วยจัดระเบียบทรัพยากรพระคัมภีร์โดยใช้ป้ายกำกับข้อ คุณสามารถเปิด/ปิดได้ตลอดเวลาที่เมนูการตั้งค่า',
    mandarin: '此实验性功能使用经文标签帮助组织圣经资源。您可以随时在设置菜单中启用/禁用它。'
  },
  verseMarkersDescription: {
    ...
    burmese: 'ကျမ်းစာ အရင်းအမြစ်များကို စီစဉ်ရန် ကူညီရန် ကျမ်းပိုဒ် စာညွှန်းများကို ဖွင့်ပါ',
  ...
  languoidLinkSuggestionDescription: {
    ...
    thai:
      'เราพบภาษาที่มีอยู่ซึ่งอาจตรงกับภาษาที่คุณสร้าง คุณต้องการเชื่อมโยงกับภาษาที่มีอยู่หรือไม่?',
    mandarin: '我们找到了可能与您创建的语言匹配的现有语言。您想链接到现有语言吗？'
  },
  yourLanguage: {
  ...
  enableLanguoidLinkSuggestionsDescription: {
    ...
    thai:
      'รับคำแนะนำเพื่อเชื่อมโยงภาษาที่คุณสร้างเองกับภาษาที่มีอยู่ในฐานข้อมูล',
