...
export const localizations = {
  ...
  sessionExpiredSignIn: {
    ...
    indonesian:
      'Sesi Anda telah berakhir. Masuk untuk menyinkronkan data Anda.',
    nepali:
      'तपाईंको सत्र समाप्त भयो। तपाईंको डाटा सिंक गर्न साइन इन गर्नुहोस्।',
    hindi:
      'आपका सत्र समाप्त हो गया है। अपना डेटा सिंक करने के लिए साइन इन करें।',
    burmese:
      'သင်၏ စက်ရှင် သက်တမ်းကုန်သွားပါပြီ။ သင့်ဒေတာကို ထပ်တူညှိရန် ဝင်ရောက်ပါ။',
    thai: 'เซสชันของคุณหมดอายุแล้ว ลงชื่อเข้าใช้เพื่อซิงค์ข้อมูลของคุณ',
    mandarin: '您的会话已过期。请登录以同步您的数据。'
  }
} as const;
