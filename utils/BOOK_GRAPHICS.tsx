...
export const BOOK_GRAPHICS: Record<string, React.FC<SvgProps>> = {
  // Old Testament
  gen: Genesis as React.FC<SvgProps>,
  exo: Exodus as React.FC<SvgProps>,
  lev: Leviticus as React.FC<SvgProps>,
  num: Numbers as React.FC<SvgProps>,
  deu: Deuteronomy as React.FC<SvgProps>,
  jos: Joshua as React.FC<SvgProps>,
  jdg: Judges as React.FC<SvgProps>,
  rut: Ruth as React.FC<SvgProps>,
  '1sa': Samuel1 as React.FC<SvgProps>,
  '2sa': Samuel2 as React.FC<SvgProps>,
  '1ki': Kings1 as React.FC<SvgProps>,
  '2ki': Kings2 as React.FC<SvgProps>,
  '1ch': Chronicles1 as React.FC<SvgProps>,
  '2ch': Chronicles2 as React.FC<SvgProps>,
  ezr: Ezra as React.FC<SvgProps>,
  neh: Nehemiah as React.FC<SvgProps>,
  est: Esther as React.FC<SvgProps>,
  job: Job as React.FC<SvgProps>,
  psa: Psalms as React.FC<SvgProps>,
  pro: Proverbs as React.FC<SvgProps>,
  ecc: Ecclesiastes as React.FC<SvgProps>,
  sng: SongOfSolomon as React.FC<SvgProps>,
  isa: Isaiah as React.FC<SvgProps>,
  jer: Jeremiah as React.FC<SvgProps>,
  lam: Lamentations as React.FC<SvgProps>,
  ezk: Ezekiel as React.FC<SvgProps>,
  dan: Daniel as React.FC<SvgProps>,
  hos: Hosea as React.FC<SvgProps>,
  joe: Joel as React.FC<SvgProps>,
  amo: Amos as React.FC<SvgProps>,
  oba: Obadiah as React.FC<SvgProps>,
  jon: Jonah as React.FC<SvgProps>,
  mic: Micah as React.FC<SvgProps>,
  nah: Nahum as React.FC<SvgProps>,
  hab: Habakkuk as React.FC<SvgProps>,
  zep: Zephaniah as React.FC<SvgProps>,
  hag: Haggai as React.FC<SvgProps>,
  zec: Zechariah as React.FC<SvgProps>,
  mal: Malachi as React.FC<SvgProps>,

  // New Testament
  mat: Matthew as React.FC<SvgProps>,
  mar: Mark as React.FC<SvgProps>,
  luk: Luke as React.FC<SvgProps>,
  joh: John as React.FC<SvgProps>,
  act: Acts as React.FC<SvgProps>,
  rom: Romans as React.FC<SvgProps>,
  '1co': Corinthians1 as React.FC<SvgProps>,
  '2co': Corinthians2 as React.FC<SvgProps>,
  gal: Galatians as React.FC<SvgProps>,
  eph: Ephesians as React.FC<SvgProps>,
  php: Philippians as React.FC<SvgProps>,
  col: Colossians as React.FC<SvgProps>,
  '1th': Thessalonians1 as React.FC<SvgProps>,
  '2th': Thessalonians2 as React.FC<SvgProps>,
  '1ti': Timothy1 as React.FC<SvgProps>,
  '2ti': Timothy2 as React.FC<SvgProps>,
  tit: Titus as React.FC<SvgProps>,
  phm: Philemon as React.FC<SvgProps>,
  heb: Hebrews as React.FC<SvgProps>,
  jas: James as React.FC<SvgProps>,
  '1pe': Peter1 as React.FC<SvgProps>,
  '2pe': Peter2 as React.FC<SvgProps>,
  '1jo': John1 as React.FC<SvgProps>,
  '2jo': John2 as React.FC<SvgProps>,
  '3jo': John3 as React.FC<SvgProps>,
  jud: Jude as React.FC<SvgProps>,
  rev: Revelation as React.FC<SvgProps>
};
