...
INSERT INTO "public"."template" ("id", "slug", "name", "icon", "structure", "auto_sync", "shared", "active") VALUES
  ('a0000000-0000-0000-0000-000000000001', 'protestant-bible-v2-frozen', 'Protestant Bible (Legacy)', 'book', '{"format_version":1,"root":{"id":"root","name":"Protestant Bible","node_type":"root","linkable_type":"quest","children":[]}}', true, true, true),
  ('a0000000-0000-0000-0000-000000000002', 'fia-v2-frozen', 'FIA Pericopes (Legacy)', 'scroll-text', '{"format_version":1,"root":{"id":"root","name":"FIA Pericopes","node_type":"root","linkable_type":"quest","children":[]}}', true, true, true)
