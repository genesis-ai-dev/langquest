...
export const InviteEmail = ({
  ...
  const translations = {
    en: {
      ...
      whatIsLangQuest: 'LangQuest helps communities create and share language learning resources. Join us to contribute translations, audio recordings, and help preserve languages worldwide.',
      instruction: 'Click the button below to create your account and join the project:',
    ...
    es: {
      ...
      whatIsLangQuest: 'LangQuest ayuda a las comunidades a crear y compartir recursos para el aprendizaje de idiomas. Únete para contribuir con traducciones, grabaciones de audio y ayudar a preservar idiomas en todo el mundo.',
      instruction: 'Haz clic en el botón de abajo para crear tu cuenta y unirte al proyecto:',
    ...
    fr: {
      ...
      whatIsLangQuest: 'LangQuest aide les communautés à créer et partager des ressources d'apprentissage des langues. Rejoignez-nous pour contribuer des traductions, des enregistrements audio et aider à préserver les langues du monde entier.',
      instruction: 'Cliquez sur le bouton ci-dessous pour créer votre compte et rejoindre le projet :',
    ...
    'pt-BR': {
      ...
      whatIsLangQuest: 'O LangQuest ajuda comunidades a criar e compartilhar recursos de aprendizado de idiomas. Junte-se a nós para contribuir com traduções, gravações de áudio e ajudar a preservar idiomas em todo o mundo.',
      instruction: 'Clique no botão abaixo para criar sua conta e participar do projeto:',
      ...
      <Tailwind>
        <Body className="bg-white">
          <Container className="px-3 mx-auto">
            ...
            <Text className="text-gray-800 text-sm my-6">{t.whatIsLangQuest}</Text>
