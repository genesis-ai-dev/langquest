...
as $$
  select jsonb_build_object(
    ...
    'min_required_schema_version', '2.2',  -- Minimum client version required
    'notes', 'Clients must be at least version 2.2 to sync. Minor updates maintain backwards compatibility.'
  );
$$;
