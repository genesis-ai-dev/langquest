-- purpose: ensure timestamp columns are set during clone inserts to satisfy NOT NULL constraints
-- updates: public.perform_clone_step to include created_at/last_updated = now() on all inserts
