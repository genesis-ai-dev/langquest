...
-- When downloading a quest, also add user to project_closure and all sibling quest_closure records
-- When downloading a project, also add user to all quest_closure records

-- Enhanced download_quest_closure function that also updates project_closure and sibling quest_closure records
...
BEGIN
    ...
    -- Logging
    RAISE NOTICE '[download_quest_closure] Completed for quest_id: %, profile_id: %. Updated % quest_closures total (including siblings)', quest_id_param, profile_id_param, quest_closures_updated;
