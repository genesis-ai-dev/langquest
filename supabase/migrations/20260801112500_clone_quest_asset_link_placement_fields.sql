-- Path A (server-only): copy quest_asset_link placement fields during project clone.
-- Based on perform_clone_step from 20260217120000_propagate_download_profiles_on_member_join.sql.
-- Without this, cloned links get name/metadata NULL and order_index 0 (column default),
-- even after the production backfill on source links.
